...
st.markdown("""
    ...
    .stButton > button:hover {
        background-color: #FFC0CB;  /* Darker Navy Blue for hover effect */
    }
...
if button_conclusion:
    st.markdown("<h2 style='text-align: center; font-size: 32px; color: black;'>Conclusion: Key Takeaways from the Titanic Survival Prediction Project</h2>", unsafe_allow_html=True)

    # Displaying the data under key takeaways in a more structured format
    st.markdown("<h4 style='font-size: 24px; font-weight: bold; color: black;'>Data Exploration & Preprocessing:</h4>", unsafe_allow_html=True)
    st.markdown(""" 
    ...
    st.markdown("<h4 style='font-size: 24px; font-weight: bold; color: black;'>Modeling & Evaluation:</h4>", unsafe_allow_html=True)
    st.markdown("""
    ...
    st.markdown("<h4 style='font-size: 24px; font-weight: bold; color: black;'>Feature Importance:</h4>", unsafe_allow_html=True)
    st.markdown("""
